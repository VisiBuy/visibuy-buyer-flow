...
const VerificationMedia = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 p-3 md:p-6 lg:px-10 relative text-[#020617]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6">
        ...
        <div className="lg:col-span-8 bg-white rounded-xl border p-3 md:p-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-semibold text-sm md:text-base">Verification Media</h3>
            <button className="text-xs md:text-sm text-blue-600">View Full Media</button>
          </div>
          ...
          <div className="mt-4 text-xs md:text-sm">
            <p className="font-medium text-sm md:text-base">iPhone 14 Pro Max – 256GB Space Black</p>
      ...
      <Modal
        title={<div className="font-semibold text-base md:text-lg">Buyer Information</div>}
        open={showBuyerInfo}
      ...
      >
        ...
        <div className="space-y-4 md:space-y-6">
          {/* Section 1: Inputs */}
          <div>
            <h5 className="font-medium mb-2 md:mb-3 text-sm md:text-base">Buyer Details</h5>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
              ...
              <Input
                ...
                className="rounded-md text-sm md:text-base"
              />
              <Input placeholder="Date" size="large" className="rounded-md text-sm md:text-base" />
              <Input
                placeholder="Country"
                size="large"
                className="rounded-md text-sm md:text-base"
          ...
          <div>
            <h5 className="font-medium mb-2 md:mb-3 text-sm md:text-base">Buyer Details Summary</h5>
          ...
          <div>
            <h5 className="font-medium mb-2 md:mb-3 text-sm md:text-base">Confirmation</h5>
      ...
      <Modal
        title={
          <div className="font-semibold text-base md:text-lg">Reject Item Verification</div>
        }
      ...
      >
        ...
        <div className="space-y-4 md:space-y-6 text-xs md:text-sm">
          ...
          {/* Rejection Form */}
          <div>
            <label className="block font-medium mb-2 text-sm md:text-base">Rejection Reason</label>
            <Select
